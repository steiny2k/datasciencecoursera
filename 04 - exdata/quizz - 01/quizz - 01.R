...
# A9: the plotting symbol/character in the base graphics system

# Q10: If I want to save a plot to a PDF file, which of the following is a correct way of doing that?
# A10: Construct the plot on the screen device and then copy it to a PDF file with dev.copy2pdf()